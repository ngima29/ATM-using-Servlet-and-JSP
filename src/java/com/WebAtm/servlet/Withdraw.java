       ...
       resp.setContentType("text/html");  
        PrintWriter out = resp.getWriter();
            try{  
	            	 ...
	            	 if (rs.next()) {    
                             TotalBalanceR = rs.getInt("amount");
             ...
             int WithBalanca = Integer.parseInt( req.getParameter("withamount"));
       
	    TotalBalanceR = (int) (TotalBalanceR - WithBalanca);
