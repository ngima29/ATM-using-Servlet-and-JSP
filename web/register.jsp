...
<html>
 ...
 <div class="row">
  <div class="col">
      <input type="number" class="form-control" placeholder="Account Number"  name="acnum" required>
  </div>
  <div class="col">
  ...
  <div class="col">
       ...
       <input type="date" class="form-control" placeholder="DOB" name="DOB" required id="start" name="trip-start" value="2022-01-22"
       min="1945-01-01" max="2022-01-22">
  </div>
   </div>
     <br>
<div class="row">
  ...
  <div class="col">
    ...
    <select class="form-select" id="autoSizingSelect" name="gender" required>
      <option selectedvalue="male">Male</option>
